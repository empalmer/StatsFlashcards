...
\begin{note}
  ...
  \end{field}
    \begin{field}
        \text{Disjoint}: Two events $A$ and $B$ are disjoint ( or mutually exclusive) if $ A \cap B = \emptyset $
    \end{field}
\end{note}
...
\begin{note}
  ...
  \end{field}
    \begin{field}
        $ \text{Two Events} A_1, A_2$ are pairwise disjoint ( or mutually exclusive) if $A_i \cap A_j = \emptyset $ for all $i \neq j$
    \end{field}
\end{note}
...
\begin{note}
    ...
    \end{field}
    \begin{field}
        \text{If }$A_1, A_2, \ldots$ are pairwise disjoint and $\cup_{i=1}^\infty A_i = S$, then the collection $A_1, A_2, \ldots$ forms a partition of $S$.
    \end{field}
\end{note}
